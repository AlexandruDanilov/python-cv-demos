...
# Old version that has the correct resolution for the picamera 2 module, this will get less updates and the main focus is on the module 3 as it is the most recent hardware. other than config, they should be similar
